	...
	<div  class="myform">
		<form action="/2019-4-28/updatenews?id=<%=news.getId()%>" method="post">
			<table>
				...
				<tr>
					<td>
						<textarea type="text" style="width: 500px ; height: 150px; margin-bottom: 10px;"><%=news.getContent() %></textarea>
					</td>
				</tr>
				...
				<tr>
					<td class="mylogin" style="text-align: center;">
						<input type="button" onclick="window.location.href='selectnews.jsp'" name="btn_cancel" value="返回" class="btn_cancel">
					</td>
				</tr>
